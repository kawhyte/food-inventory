...
const PAGE_SIZE = 15;
const FIELDS =
  "id, name, quantity, unit, expiry_date, status, needs_restock, updated_at, location_id, category_id, barcode, image_url, is_perishable, locations(name), categories(name)";
